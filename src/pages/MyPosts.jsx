        ...
        <Container>
            <div className="flex flex-wrap">
                <div className="p-2 w-full">
                    <img src="\public\assets\Not-Found.png" alt="Not found image" className='w-full max-w-[130px] sm:max-w-[130px] md:max-w-[130px] lg:max-w-[130px] xl:max-w-[200px] h-auto mx-auto mb-4 rounded-2xl' 
                    />
