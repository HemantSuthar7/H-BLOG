    ...
    <div className='max-w-full py-8 min-h-screen'>
      <div className='mx-6'>
        <div className='text-center'>
           ...
           <img src="\assets\H-Blog_home_img_01.png" alt="Blog with H-Blog" className='w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl h-auto mx-auto mb-4' 
           />
        <div className='text-center'>
            <h1 className='mb-4 text-3xl font-bold text-gray-900 dark:text-white md:text-5xl lg:text-6xl text-wrap'>
           ...
           <img src="\assets\H-Blog_home_img_02.png" alt="Blog with H-Blog" className='w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl h-auto mx-auto mb-4' 
           />
        <div className='text-center'>
            <h1 className='mb-4 text-3xl font-bold text-gray-900 dark:text-white md:text-5xl lg:text-6xl text-wrap'>
           ...
           <img src="\assets\H-Blog_home_img_03.png" alt="Blog with H-Blog" className='w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl h-auto mx-auto mb-4' 
           />
        <div className='text-center'>
            <h1 className='mb-4 text-3xl font-bold text-gray-900 dark:text-white md:text-5xl lg:text-6xl text-wrap'>
           ...
           <img src="\assets\H-Blog_home_img_04.png" alt="Blog with H-Blog" className='w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl h-auto mx-auto mb-4' 
           />
      </div>   
    </div>
  )
